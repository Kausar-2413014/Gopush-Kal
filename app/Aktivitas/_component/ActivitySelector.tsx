...
export default function ActivitySelector({ onSelect }: ActivitySelectorProps) {
  ...
  return (
    ...
    >
      <h2 className="text-2xl font-bold text-white mb-6 text-center">Berapa kali Anda berolahraga hari ini?</h2>
      ...
      <p className="text-gray-500 mt-6 text-sm text-center">Pilih frekuensi olahraga untuk memunculkan kotak input aktivitas.</p>
    </motion.div>
  );
}